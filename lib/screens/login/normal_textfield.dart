...
class NormalTextFields extends StatefulWidget
{
  ...
  NormalTextFields({required this.hintText, required this.textController, required this.prefixIcon, required this.inputType, this.filteringTextInputFromatter});
