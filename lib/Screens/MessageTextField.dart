...
class MessageTextField extends StatefulWidget
{
  ...
  MessageTextField({required this.hintText, required this.maxLines, required this.inputType, required this.filteringTextInputFromatter});
    ...
    return ValueListenableBuilder(
      ...
      builder: (_, isFocus, child)
      {
        return TextFormField(
          key: formKey,
          controller: MessageTextField.textController,
          validator: (value){
